<%@ page import="com.xzf.servlet.CookieUtils" %>
	...
	<body>
		...
		<div style="width:1210px;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
			...
			<div style="overflow: hidden;">
				...
				Cookie cook = CookieUtils.findCookieValue(cookie, "history");
				if(cook == null){
				%>
					<h2>您还没浏览任何商品</h2>
					<%
				...
				for(String i : id){
					%>
					<li style="width: 150px;height: 216px;float: left;margin: 0 8px 0 0;padding: 0 18px 15px;text-align: center;"><img src="products/1/cs1000<%=i %>.jpg" width="130px" height="130px" /></li>
					<%
					}
					%>
				<div>
					<a href="/clear_history"><h2>清除浏览记录</h2></a>
				</div>
					<%
					}
					%>
